...
- [inner](NotFoundError.md#inner)
- [message](NotFoundError.md#message)
- [name](NotFoundError.md#name)
- [properties](NotFoundError.md#properties)
- [source](NotFoundError.md#source)
- [stack](NotFoundError.md#stack)
- [CLASS\_NAME](NotFoundError.md#class_name)

### Methods

- [toJsonObject](NotFoundError.md#tojsonobject)
- [expand](NotFoundError.md#expand)
- [flatten](NotFoundError.md#flatten)
- [fromError](NotFoundError.md#fromerror)
- [isErrorCode](NotFoundError.md#iserrorcode)
- [isErrorMessage](NotFoundError.md#iserrormessage)
- [isErrorName](NotFoundError.md#iserrorname)
- [someErrorCode](NotFoundError.md#someerrorcode)
- [someErrorMessage](NotFoundError.md#someerrormessage)
- [someErrorName](NotFoundError.md#someerrorname)
...
[packages/core/src/errors/notFoundError.ts:22](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/notFoundError.ts#L22)
...
[packages/core/src/errors/notFoundError.ts:13](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/notFoundError.ts#L13)
