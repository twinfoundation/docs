...
- [cause](UnauthorizedError.md#cause)
- [inner](UnauthorizedError.md#inner)
- [message](UnauthorizedError.md#message)
- [name](UnauthorizedError.md#name)
- [properties](UnauthorizedError.md#properties)
- [source](UnauthorizedError.md#source)
- [stack](UnauthorizedError.md#stack)
- [CLASS\_NAME](UnauthorizedError.md#class_name)

### Methods

- [toJsonObject](UnauthorizedError.md#tojsonobject)
- [expand](UnauthorizedError.md#expand)
- [flatten](UnauthorizedError.md#flatten)
- [fromError](UnauthorizedError.md#fromerror)
- [isErrorCode](UnauthorizedError.md#iserrorcode)
- [isErrorMessage](UnauthorizedError.md#iserrormessage)
- [isErrorName](UnauthorizedError.md#iserrorname)
- [someErrorCode](UnauthorizedError.md#someerrorcode)
- [someErrorMessage](UnauthorizedError.md#someerrormessage)
- [someErrorName](UnauthorizedError.md#someerrorname)
...
[packages/core/src/errors/unauthorizedError.ts:21](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/unauthorizedError.ts#L21)
...
[packages/core/src/errors/unauthorizedError.ts:13](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/unauthorizedError.ts#L13)
