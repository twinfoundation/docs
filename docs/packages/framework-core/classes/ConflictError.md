...
- [cause](ConflictError.md#cause)
- [inner](ConflictError.md#inner)
- [message](ConflictError.md#message)
- [name](ConflictError.md#name)
- [properties](ConflictError.md#properties)
- [source](ConflictError.md#source)
- [stack](ConflictError.md#stack)
- [CLASS\_NAME](ConflictError.md#class_name)

### Methods

- [toJsonObject](ConflictError.md#tojsonobject)
- [expand](ConflictError.md#expand)
- [flatten](ConflictError.md#flatten)
- [fromError](ConflictError.md#fromerror)
- [isErrorCode](ConflictError.md#iserrorcode)
- [isErrorMessage](ConflictError.md#iserrormessage)
- [isErrorName](ConflictError.md#iserrorname)
- [someErrorCode](ConflictError.md#someerrorcode)
- [someErrorMessage](ConflictError.md#someerrormessage)
- [someErrorName](ConflictError.md#someerrorname)
...
[packages/core/src/errors/conflictError.ts:23](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/conflictError.ts#L23)
...
[packages/core/src/errors/conflictError.ts:13](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/conflictError.ts#L13)
