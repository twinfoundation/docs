...
- [constructor](GuardError.md#constructor)

### Properties

- [cause](GuardError.md#cause)
- [inner](GuardError.md#inner)
- [message](GuardError.md#message)
- [name](GuardError.md#name)
- [properties](GuardError.md#properties)
- [source](GuardError.md#source)
- [stack](GuardError.md#stack)
- [CLASS\_NAME](GuardError.md#class_name)

### Methods

- [toJsonObject](GuardError.md#tojsonobject)
- [expand](GuardError.md#expand)
- [flatten](GuardError.md#flatten)
- [fromError](GuardError.md#fromerror)
- [isErrorCode](GuardError.md#iserrorcode)
- [isErrorMessage](GuardError.md#iserrormessage)
- [isErrorName](GuardError.md#iserrorname)
- [someErrorCode](GuardError.md#someerrorcode)
- [someErrorMessage](GuardError.md#someerrormessage)
- [someErrorName](GuardError.md#someerrorname)
