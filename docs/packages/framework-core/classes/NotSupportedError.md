...
- [cause](NotSupportedError.md#cause)
- [inner](NotSupportedError.md#inner)
- [message](NotSupportedError.md#message)
- [name](NotSupportedError.md#name)
- [properties](NotSupportedError.md#properties)
- [source](NotSupportedError.md#source)
- [stack](NotSupportedError.md#stack)
- [CLASS\_NAME](NotSupportedError.md#class_name)

### Methods

- [toJsonObject](NotSupportedError.md#tojsonobject)
- [expand](NotSupportedError.md#expand)
- [flatten](NotSupportedError.md#flatten)
- [fromError](NotSupportedError.md#fromerror)
- [isErrorCode](NotSupportedError.md#iserrorcode)
- [isErrorMessage](NotSupportedError.md#iserrormessage)
- [isErrorName](NotSupportedError.md#iserrorname)
- [someErrorCode](NotSupportedError.md#someerrorcode)
- [someErrorMessage](NotSupportedError.md#someerrormessage)
- [someErrorName](NotSupportedError.md#someerrorname)
...
[packages/core/src/errors/notSupportedError.ts:21](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/notSupportedError.ts#L21)
...
[packages/core/src/errors/notSupportedError.ts:13](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/notSupportedError.ts#L13)
