...
- [constructor](GeneralError.md#constructor)

### Properties

- [cause](GeneralError.md#cause)
- [inner](GeneralError.md#inner)
- [message](GeneralError.md#message)
- [name](GeneralError.md#name)
- [properties](GeneralError.md#properties)
- [source](GeneralError.md#source)
- [stack](GeneralError.md#stack)
- [CLASS\_NAME](GeneralError.md#class_name)

### Methods

- [toJsonObject](GeneralError.md#tojsonobject)
- [expand](GeneralError.md#expand)
- [flatten](GeneralError.md#flatten)
- [fromError](GeneralError.md#fromerror)
- [isErrorCode](GeneralError.md#iserrorcode)
- [isErrorMessage](GeneralError.md#iserrormessage)
- [isErrorName](GeneralError.md#iserrorname)
- [someErrorCode](GeneralError.md#someerrorcode)
- [someErrorMessage](GeneralError.md#someerrormessage)
- [someErrorName](GeneralError.md#someerrorname)
...
[packages/core/src/errors/generalError.ts:22](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/generalError.ts#L22)
...
[packages/core/src/errors/generalError.ts:13](https://github.com/gtscio/framework/blob/ed1186b/packages/core/src/errors/generalError.ts#L13)
