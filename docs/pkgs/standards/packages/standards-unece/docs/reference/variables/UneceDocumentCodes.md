...
> **PurchaseOrder**: `string` = `"unece:DocumentCodeList#105"`
...
> **TransportLoadingReport**: `string` = `"unece:DocumentCodeList#122"`
...
> **WeightCertificate**: `string` = `"unece:DocumentCodeList#14"`
...
> **SubcontractorPlan**: `string` = `"unece:DocumentCodeList#157"`
...
> **ContainerStrippingOrder**: `string` = `"unece:DocumentCodeList#183"`
...
> **PricedTenderBOQ**: `string` = `"unece:DocumentCodeList#209"`
...
> **ContainerList**: `string` = `"unece:DocumentCodeList#235"`
...
> **SelfBilledCreditNote**: `string` = `"unece:DocumentCodeList#261"`
...
> **KanbanSchedule**: `string` = `"unece:DocumentCodeList#288"`
...
> **ApplicationErrorMessage**: `string` = `"unece:DocumentCodeList#313"`
...
> **SupplementaryDocumentForApplicationForTransportOfDangerousGoods**: `string` = `"unece:DocumentCodeList#321"`
...
> **OrderStatusEnquiry**: `string` = `"unece:DocumentCodeList#347"`
...
> **CustomsSummaryDeclarationWithoutCommercialDetailAlternate**: `string` = `"unece:DocumentCodeList#355"`
...
> **Prescription**: `string` = `"unece:DocumentCodeList#372"`
...
> **TransshipmentDespatchAdvice**: `string` = `"unece:DocumentCodeList#399"`
...
> **WCOFirstStepOfTwoStepExportDeclaration**: `string` = `"unece:DocumentCodeList#424"`
...
> **PaymentOrder**: `string` = `"unece:DocumentCodeList#450"`
...
> **DocumentaryCreditAmendmentNotification**: `string` = `"unece:DocumentCodeList#468"`
...
> **WCOSecondStepOfTwoStepExportDeclaration**: `string` = `"unece:DocumentCodeList#495"`
...
### SpecialRequirementsPermitRelatedToTheTransportOfCargo
...
> **SafetyAndHazardDataSheet**: `string` = `"unece:DocumentCodeList#53"`
...
> **ProductSpecificationReport**: `string` = `"unece:DocumentCodeList#6"`
...
### ConventionOnInternationalTradeInEndangeredSpeciesOfWildFaunaAndFloraCITESCertificate
...
> **CertificateOfFoodItemTransportReadiness**: `string` = `"unece:DocumentCodeList#642"`
...
> **CurrentAccount**: `string` = `"unece:DocumentCodeList#66"`
...
> **ProductDataResponse**: `string` = `"unece:DocumentCodeList#721"`
...
> **MeteredServicesConsumptionReportSupportingAnInvoice**: `string` = `"unece:DocumentCodeList#739"`
...
> **EuropeanSingleProcurementDocumentRequest**: `string` = `"unece:DocumentCodeList#756"`
...
> **CoverageConfirmationNote**: `string` = `"unece:DocumentCodeList#773"`
...
> **FirstSampleTestReport**: `string` = `"unece:DocumentCodeList#8"`
...
> **PaymentReceiptConfirmation**: `string` = `"unece:DocumentCodeList#834"`
...
> **OutOfCourtSettlement**: `string` = `"unece:DocumentCodeList#847"`

Out of court settlement: 847.

### LegalAction

> **LegalAction**: `string` = `"unece:DocumentCodeList#848"`

Legal action: 848.

### Summons

> **Summons**: `string` = `"unece:DocumentCodeList#849"`

Summons: 849.

### CustomsManifest

> **CustomsManifest**: `string` = `"unece:DocumentCodeList#85"`

Customs manifest: 85.

### ApplicationForPhytosanitaryCertificate

> **ApplicationForPhytosanitaryCertificate**: `string` = `"unece:DocumentCodeList#850"`

Application for phytosanitary certificate: 850.

### PhytosanitaryCertificate

> **PhytosanitaryCertificate**: `string` = `"unece:DocumentCodeList#851"`

Phytosanitary certificate: 851.

### SanitaryCertificate

> **SanitaryCertificate**: `string` = `"unece:DocumentCodeList#852"`

Sanitary certificate: 852.

### VeterinaryCertificate

> **VeterinaryCertificate**: `string` = `"unece:DocumentCodeList#853"`

Veterinary certificate: 853.

### CourtJudgment

> **CourtJudgment**: `string` = `"unece:DocumentCodeList#854"`

Court judgment: 854.

### ApplicationForInspectionCertificate

> **ApplicationForInspectionCertificate**: `string` = `"unece:DocumentCodeList#855"`

Application for inspection certificate: 855.

### InspectionCertificate

> **InspectionCertificate**: `string` = `"unece:DocumentCodeList#856"`

Inspection certificate: 856.

### VehicleAboardDocument

> **VehicleAboardDocument**: `string` = `"unece:DocumentCodeList#857"`

Vehicle aboard document: 857.

### Image

> **Image**: `string` = `"unece:DocumentCodeList#858"`

Image: 858.

### Audio

> **Audio**: `string` = `"unece:DocumentCodeList#859"`

Audio: 859.

### VesselUnpackReport

> **VesselUnpackReport**: `string` = `"unece:DocumentCodeList#86"`

Vessel unpack report: 86.

### CertificateOfOriginApplicationFor

> **CertificateOfOriginApplicationFor**: `string` = `"unece:DocumentCodeList#860"`

Certificate of origin, application for: 860.

### CertificateOfOrigin

> **CertificateOfOrigin**: `string` = `"unece:DocumentCodeList#861"`

Certificate of origin: 861.

### DeclarationOfOrigin

> **DeclarationOfOrigin**: `string` = `"unece:DocumentCodeList#862"`

Declaration of origin: 862.

### RegionalAppellationCertificate

> **RegionalAppellationCertificate**: `string` = `"unece:DocumentCodeList#863"`

Regional appellation certificate: 863.

### PreferenceCertificateOfOrigin

> **PreferenceCertificateOfOrigin**: `string` = `"unece:DocumentCodeList#864"`

Preference certificate of origin: 864.

### CertificateOfOriginFormGSP

> **CertificateOfOriginFormGSP**: `string` = `"unece:DocumentCodeList#865"`

Certificate of origin form GSP: 865.

### Video

> **Video**: `string` = `"unece:DocumentCodeList#866"`

Video: 866.

### IntroductoryLetter

> **IntroductoryLetter**: `string` = `"unece:DocumentCodeList#867"`

Introductory letter: 867.

### DataProtectionRegulationsStatement

> **DataProtectionRegulationsStatement**: `string` = `"unece:DocumentCodeList#868"`

Data protection regulations statement: 868.

### ExclusiveBrokerageMandate

> **ExclusiveBrokerageMandate**: `string` = `"unece:DocumentCodeList#869"`

Exclusive brokerage mandate: 869.

### GeneralCargoSummaryManifestReport

> **GeneralCargoSummaryManifestReport**: `string` = `"unece:DocumentCodeList#87"`

General cargo summary manifest report: 87.

### ConsularInvoice

> **ConsularInvoice**: `string` = `"unece:DocumentCodeList#870"`

Consular invoice: 870.

### InquiryMandate

> **InquiryMandate**: `string` = `"unece:DocumentCodeList#871"`

Inquiry mandate: 871.

### RiskAnalysis

> **RiskAnalysis**: `string` = `"unece:DocumentCodeList#872"`

Risk analysis: 872.

### TransportEquipmentMovementReportPartial

> **TransportEquipmentMovementReportPartial**: `string` = `"unece:DocumentCodeList#873"`

Transport equipment movement report, partial: 873.

### ConveyanceDeclaration

> **ConveyanceDeclaration**: `string` = `"unece:DocumentCodeList#874"`

Conveyance declaration: 874.

### PartialConstructionInvoice

> **PartialConstructionInvoice**: `string` = `"unece:DocumentCodeList#875"`

Partial construction invoice: 875.

### PartialFinalConstructionInvoice

> **PartialFinalConstructionInvoice**: `string` = `"unece:DocumentCodeList#876"`

Partial final construction invoice: 876.

### FinalConstructionInvoice

> **FinalConstructionInvoice**: `string` = `"unece:DocumentCodeList#877"`

Final construction invoice: 877.

### AEOCertificateOfSecurityAndOrSafety

> **AEOCertificateOfSecurityAndOrSafety**: `string` = `"unece:DocumentCodeList#878"`

AEO Certificate of Security and/or Safety: 878.

### AEOCertificateOfConformityOrCompliance

> **AEOCertificateOfConformityOrCompliance**: `string` = `"unece:DocumentCodeList#879"`

AEO Certificate of Conformity or Compliance: 879.

### ConsignmentUnpackReport

> **ConsignmentUnpackReport**: `string` = `"unece:DocumentCodeList#88"`

Consignment unpack report: 88.

### MeatAndMeatByProductsSanitaryCertificate

> **MeatAndMeatByProductsSanitaryCertificate**: `string` = `"unece:DocumentCodeList#89"`

Meat and meat by-products sanitary certificate: 89.

### DangerousGoodsDeclaration

> **DangerousGoodsDeclaration**: `string` = `"unece:DocumentCodeList#890"`

Dangerous goods declaration: 890.

### AEOCertificateFull

> **AEOCertificateFull**: `string` = `"unece:DocumentCodeList#891"`

AEO Certificate Full: 891.

### PurchaseOrderFinancingRequest

> **PurchaseOrderFinancingRequest**: `string` = `"unece:DocumentCodeList#892"`

Purchase Order Financing Request: 892.

### PurchaseOrderFinancingRequestStatus

> **PurchaseOrderFinancingRequestStatus**: `string` = `"unece:DocumentCodeList#893"`

Purchase Order Financing Request Status: 893.

### PurchaseOrderFinancingRequestCancellation

> **PurchaseOrderFinancingRequestCancellation**: `string` = `"unece:DocumentCodeList#894"`

Purchase Order Financing Request Cancellation: 894.

### StatisticalDocumentExport

> **StatisticalDocumentExport**: `string` = `"unece:DocumentCodeList#895"`

Statistical document, export: 895.

### INTRASTATDeclaration

> **INTRASTATDeclaration**: `string` = `"unece:DocumentCodeList#896"`

INTRASTAT declaration: 896.

### TransitCertificateOfApproval

> **TransitCertificateOfApproval**: `string` = `"unece:DocumentCodeList#897"`

Transit certificate of approval: 897.

### PrePackedCrossDockingConsignmentOrder

> **PrePackedCrossDockingConsignmentOrder**: `string` = `"unece:DocumentCodeList#898"`

Pre-packed cross docking consignment order: 898.

### TraceabilityEventDeclaration

> **TraceabilityEventDeclaration**: `string` = `"unece:DocumentCodeList#899"`

Traceability event declaration: 899.

### PriceSalesCatalogue

> **PriceSalesCatalogue**: `string` = `"unece:DocumentCodeList#9"`

Price/sales catalogue: 9.

### MeatFoodProductsSanitaryCertificate

> **MeatFoodProductsSanitaryCertificate**: `string` = `"unece:DocumentCodeList#90"`

Meat food products sanitary certificate: 90.

### SustainabilityDataRequest

> **SustainabilityDataRequest**: `string` = `"unece:DocumentCodeList#900"`

Sustainability data request: 900.

### DeliveryVerificationCertificate

> **DeliveryVerificationCertificate**: `string` = `"unece:DocumentCodeList#901"`

Delivery verification certificate: 901.

### SustainabilityDataResponse

> **SustainabilityDataResponse**: `string` = `"unece:DocumentCodeList#902"`

Sustainability data response: 902.

### SustainabilityInspectionRequest

> **SustainabilityInspectionRequest**: `string` = `"unece:DocumentCodeList#903"`

Sustainability Inspection request: 903.

### SustainabilityInspectionResponse

> **SustainabilityInspectionResponse**: `string` = `"unece:DocumentCodeList#904"`

Sustainability Inspection response: 904.

### AirConsignmentSecurityDeclaration

> **AirConsignmentSecurityDeclaration**: `string` = `"unece:DocumentCodeList#905"`

Air Consignment Security Declaration: 905.

### PoultrySanitaryCertificate

> **PoultrySanitaryCertificate**: `string` = `"unece:DocumentCodeList#91"`

Poultry sanitary certificate: 91.

### ImportLicenceApplicationFor

> **ImportLicenceApplicationFor**: `string` = `"unece:DocumentCodeList#910"`

Import licence, application for: 910.

### ImportLicence

> **ImportLicence**: `string` = `"unece:DocumentCodeList#911"`

Import licence: 911.

### CustomsDeclarationWithoutCommercialDetail

> **CustomsDeclarationWithoutCommercialDetail**: `string` = `"unece:DocumentCodeList#913"`

Customs declaration without commercial detail: 913.

### CustomsDeclarationWithCommercialAndItemDetail

> **CustomsDeclarationWithCommercialAndItemDetail**: `string` = `"unece:DocumentCodeList#914"`

Customs declaration with commercial and item detail: 914.

### CustomsDeclarationWithoutItemDetail

> **CustomsDeclarationWithoutItemDetail**: `string` = `"unece:DocumentCodeList#915"`

Customs declaration without item detail: 915.

### RelatedDocument

> **RelatedDocument**: `string` = `"unece:DocumentCodeList#916"`

Related document: 916.

### ReceiptCustoms

> **ReceiptCustoms**: `string` = `"unece:DocumentCodeList#917"`

Receipt (Customs): 917.

### HorsemeatSanitaryCertificate

> **HorsemeatSanitaryCertificate**: `string` = `"unece:DocumentCodeList#92"`

Horsemeat sanitary certificate: 92.

### ApplicationForExchangeAllocation

> **ApplicationForExchangeAllocation**: `string` = `"unece:DocumentCodeList#925"`

Application for exchange allocation: 925.

### ForeignExchangePermit

> **ForeignExchangePermit**: `string` = `"unece:DocumentCodeList#926"`

Foreign exchange permit: 926.

### ExchangeControlDeclarationImport

> **ExchangeControlDeclarationImport**: `string` = `"unece:DocumentCodeList#927"`

Exchange control declaration (import): 927.

### GoodsDeclarationForImportation

> **GoodsDeclarationForImportation**: `string` = `"unece:DocumentCodeList#929"`

Goods declaration for importation: 929.

### CasingSanitaryCertificate

> **CasingSanitaryCertificate**: `string` = `"unece:DocumentCodeList#93"`

Casing sanitary certificate: 93.

### GoodsDeclarationForHomeUse

> **GoodsDeclarationForHomeUse**: `string` = `"unece:DocumentCodeList#930"`

Goods declaration for home use: 930.

### CustomsImmediateReleaseDeclaration

> **CustomsImmediateReleaseDeclaration**: `string` = `"unece:DocumentCodeList#931"`

Customs immediate release declaration: 931.

### CustomsDeliveryNote

> **CustomsDeliveryNote**: `string` = `"unece:DocumentCodeList#932"`

Customs delivery note: 932.

### CargoDeclarationArrival

> **CargoDeclarationArrival**: `string` = `"unece:DocumentCodeList#933"`

Cargo declaration (arrival): 933.

### ValueDeclaration

> **ValueDeclaration**: `string` = `"unece:DocumentCodeList#934"`

Value declaration: 934.

### CustomsInvoice

> **CustomsInvoice**: `string` = `"unece:DocumentCodeList#935"`

Customs invoice: 935.

### CustomsDeclarationPostParcels

> **CustomsDeclarationPostParcels**: `string` = `"unece:DocumentCodeList#936"`

Customs declaration (post parcels): 936.

### TaxDeclarationValueAddedTax

> **TaxDeclarationValueAddedTax**: `string` = `"unece:DocumentCodeList#937"`

Tax declaration (value added tax): 937.

### TaxDeclarationGeneral

> **TaxDeclarationGeneral**: `string` = `"unece:DocumentCodeList#938"`

Tax declaration (general): 938.

### PharmaceuticalSanitaryCertificate

> **PharmaceuticalSanitaryCertificate**: `string` = `"unece:DocumentCodeList#94"`

Pharmaceutical sanitary certificate: 94.

### TaxDemand

> **TaxDemand**: `string` = `"unece:DocumentCodeList#940"`

Tax demand: 940.

### EmbargoPermit

> **EmbargoPermit**: `string` = `"unece:DocumentCodeList#941"`

Embargo permit: 941.

### InedibleSanitaryCertificate

> **InedibleSanitaryCertificate**: `string` = `"unece:DocumentCodeList#95"`

Inedible sanitary certificate: 95.

### GoodsDeclarationForCustomsTransit

> **GoodsDeclarationForCustomsTransit**: `string` = `"unece:DocumentCodeList#950"`

Goods declaration for Customs transit: 950.

### TIFForm

> **TIFForm**: `string` = `"unece:DocumentCodeList#951"`

TIF form: 951.

### TIRCarnet

> **TIRCarnet**: `string` = `"unece:DocumentCodeList#952"`

TIR carnet: 952.

### ECCarnet

> **ECCarnet**: `string` = `"unece:DocumentCodeList#953"`

EC carnet: 953.

### EUR1CertificateOfOrigin

> **EUR1CertificateOfOrigin**: `string` = `"unece:DocumentCodeList#954"`

EUR 1 certificate of origin: 954.

### ATACarnet

> **ATACarnet**: `string` = `"unece:DocumentCodeList#955"`

ATA carnet: 955.

### ImpendingArrival

> **ImpendingArrival**: `string` = `"unece:DocumentCodeList#96"`

Impending arrival: 96.

### SingleAdministrativeDocument

> **SingleAdministrativeDocument**: `string` = `"unece:DocumentCodeList#960"`

Single administrative document: 960.

### GeneralResponseCustoms

> **GeneralResponseCustoms**: `string` = `"unece:DocumentCodeList#961"`

General response (Customs): 961.

### DocumentResponseCustoms

> **DocumentResponseCustoms**: `string` = `"unece:DocumentCodeList#962"`

Document response (Customs): 962.

### ErrorResponseCustoms

> **ErrorResponseCustoms**: `string` = `"unece:DocumentCodeList#963"`

Error response (Customs): 963.

### PackageResponseCustoms

> **PackageResponseCustoms**: `string` = `"unece:DocumentCodeList#964"`

Package response (Customs): 964.

### TaxCalculationConfirmationResponseCustoms

> **TaxCalculationConfirmationResponseCustoms**: `string` = `"unece:DocumentCodeList#965"`

Tax calculation/confirmation response (Customs): 965.

### QuotaPriorAllocationCertificate

> **QuotaPriorAllocationCertificate**: `string` = `"unece:DocumentCodeList#966"`

Quota prior allocation certificate: 966.

### MeansOfTransportAdvice

> **MeansOfTransportAdvice**: `string` = `"unece:DocumentCodeList#97"`

Means of transport advice: 97.

### WagonReport

> **WagonReport**: `string` = `"unece:DocumentCodeList#970"`

Wagon report: 970.

### TransitConveyorDocument

> **TransitConveyorDocument**: `string` = `"unece:DocumentCodeList#971"`

Transit Conveyor Document: 971.

### RailConsignmentNoteForwarderCopy

> **RailConsignmentNoteForwarderCopy**: `string` = `"unece:DocumentCodeList#972"`

Rail consignment note forwarder copy: 972.

### DutySuspendedGoods

> **DutySuspendedGoods**: `string` = `"unece:DocumentCodeList#974"`

Duty suspended goods: 974.

### ProofOfTransitDeclaration

> **ProofOfTransitDeclaration**: `string` = `"unece:DocumentCodeList#975"`

Proof of transit declaration: 975.

### ContainerTransferNote

> **ContainerTransferNote**: `string` = `"unece:DocumentCodeList#976"`

Container transfer note: 976.

### NATOTransitDocument

> **NATOTransitDocument**: `string` = `"unece:DocumentCodeList#977"`

NATO transit document: 977.

### TransfrontierWasteShipmentAuthorization

> **TransfrontierWasteShipmentAuthorization**: `string` = `"unece:DocumentCodeList#978"`

Transfrontier waste shipment authorization: 978.

### TransfrontierWasteShipmentMovementDocument

> **TransfrontierWasteShipmentMovementDocument**: `string` = `"unece:DocumentCodeList#979"`

Transfrontier waste shipment movement document: 979.

### ArrivalInformation

> **ArrivalInformation**: `string` = `"unece:DocumentCodeList#98"`

Arrival information: 98.

### CargoReleaseNotification

> **CargoReleaseNotification**: `string` = `"unece:DocumentCodeList#99"`

Cargo release notification: 99.

### EndUseAuthorization

> **EndUseAuthorization**: `string` = `"unece:DocumentCodeList#990"`

End use authorization: 990.

### GovernmentContract

> **GovernmentContract**: `string` = `"unece:DocumentCodeList#991"`

Government contract: 991.

### StatisticalDocumentImport

> **StatisticalDocumentImport**: `string` = `"unece:DocumentCodeList#995"`

Statistical document, import: 995.

### ApplicationForDocumentaryCredit

> **ApplicationForDocumentaryCredit**: `string` = `"unece:DocumentCodeList#996"`

Application for documentary credit: 996.

### PreviousCustomsDocumentMessage

> **PreviousCustomsDocumentMessage**: `string` = `"unece:DocumentCodeList#998"`
